...
public class RequestUtils {
     ...
     * @param request A payment request {@link PaymentRequest}
     * @return The StringEntity representation of request
     */
    public static <T> StringEntity toJson(ObjectMapper om, Request<T> request) throws UnsupportedEncodingException {
        try {
